...
import com.hst.spdiframework.context.exception.NotLoadedException;
import com.hst.spdiframework.context.support.LifeCycle;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import com.hst.spdiframework.beans.factory.AbstractBeanFactory;
import com.hst.spdiframework.beans.factory.BeanFactory;
...
public abstract class ApplicationContext extends LifeCycle {
	...
	public <T> T getBean(String beanName, Class<T> clazz) { 
		...
		{
			throw new NotLoadedException("���ؽ�Ʈ�� �ε���� �ʾҽ��ϴ�.");
		}
	}
