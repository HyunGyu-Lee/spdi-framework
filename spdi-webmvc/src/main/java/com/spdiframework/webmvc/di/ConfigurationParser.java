...
public class ConfigurationParser {
	...
	public static ContainerConfiguration parse(String containerConfig) {
//		ContainerConfiguration c = JsonUtils.fromJson(containerConfig, ContainerConfiguration.class);
//
